...
public class TestActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mx_download_test_activity2);
        File file = TestActivity2.this.getExternalFilesDir("");
        ...
        if (downloadInfo == null) {
            ...
            if (downloadInfo.getState().equals(HttpHandler.State.LOADING)) {
                ...
                if (handler != null) {
//                    handler.setRequestCallBack(new DownloadRequestCallBack(contentId,progressBar,stopButton));
        ...
        jumpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(TestActivity2.this, TestActivity1.class));
            }
        });
