...
import com.brandontate.androidwebviewselection.QuickAction.OnDismissListener;
...
public class BTWebView extends WebView implements TextSelectionJavascriptInterfaceListener, OnTouchListener, OnLongClickListener, OnDismissListener, DragListener{
...
////			menu.clear();
//			// mode.getMenuInflater().inflate(R.menu.ym_epub_lib_web_view_selection, menu);
