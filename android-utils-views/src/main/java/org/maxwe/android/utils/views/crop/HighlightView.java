...
package org.maxwe.android.utils.views.crop;
...
class HighlightView {
    ...
    private void initStyles(Context context) {
        ...
        context.getTheme().resolveAttribute(R.attr.org_maxwe_views_cropImageStyle, outValue, true);
        TypedArray attributes = context.obtainStyledAttributes(outValue.resourceId, R.styleable.org_maxwe_views_cropImageView);
        try {
            showThirds = attributes.getBoolean(R.styleable.org_maxwe_views_cropImageView_org_maxwe_views_showThirds, false);
            showCircle = attributes.getBoolean(R.styleable.org_maxwe_views_cropImageView_org_maxwe_views_showCircle, false);
            highlightColor = attributes.getColor(R.styleable.org_maxwe_views_cropImageView_org_maxwe_views_highlightColor,
                    DEFAULT_HIGHLIGHT_COLOR);
            handleMode = HandleMode.values()[attributes.getInt(R.styleable.org_maxwe_views_cropImageView_org_maxwe_views_showHandles, 0)];
        } finally {
            attributes.recycle();
        }
    }
