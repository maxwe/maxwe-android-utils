...
public class Crop {
    ...
    public static final int REQUEST_CROP_CAMERA = 8080;
    public static final int REQUEST_CROP_GALLEYR = 9090;
    ...
    public static void pickImage(Activity activity) {
        pickImage(activity, currentRequestCode);
    }
    ...
    private static Intent intent = new Intent(Intent.ACTION_GET_CONTENT).setType("image/*");
...
//        return new Intent(Intent.ACTION_GET_CONTENT).setType("image/*");
    ...
    public static void setCameraIntent(Uri uri){
...
//        intent.putExtra(MediaStore.EXTRA_OUTPUT, insert);
    ...
    public static void setGalleryIntent(){
        intent = new Intent(Intent.ACTION_GET_CONTENT).setType("image/*");
    }

    private static int currentRequestCode = REQUEST_PICK;
    public static void setRequestCode(int requestCode){
        currentRequestCode = requestCode;
    }

    private static void showImagePickerError(Context context) {
        Toast.makeText(context.getApplicationContext(), R.string.org_maxwe_views_crop_pick_error, Toast.LENGTH_SHORT).show();
    }
