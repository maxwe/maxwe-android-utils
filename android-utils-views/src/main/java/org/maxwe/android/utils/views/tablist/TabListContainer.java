...
public class TabListContainer extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        this.imageView = (ImageView) this.getChildAt(0);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (MotionEvent.ACTION_DOWN == action) {
            ...
            if (height > 0){
                this.imageView.layout(0,0,this.imageView.getWidth(),(int)(height - (currentTouchMoveY - preTouchMoveY)));
                this.preTouchMoveY = (int)ev.getRawY();
                return false;
            }else{
